...
// Types pour les médias importés
...
export interface ImportedMedia {
  ...
  lastModified: number;
  preview?: string;
  // Données pour la persistance
  fileData?: string; // base64 data du fichier original
  previewData?: string; // base64 data du preview/thumbnail
  metadata?: {
    previewUrl?: string;
    originalFile?: File;
    author?: string;
