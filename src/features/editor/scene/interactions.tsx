  ...
  return (
    <>
      <Moveable
        ...
        // DEBUG SNAPPING - MAXIMUM DE PROPRIÉTÉS POUR FORCER LE SNAP VERTICAL
        snappable={true}
        snapThreshold={1000} // Valeur très élevée pour test
        
        // Guidelines explicites avec valeurs debuggées
        verticalGuidelines={[960]} // Centre exact pour 1920px de largeur
        horizontalGuidelines={[540]} // Centre exact pour 1080px de hauteur
        
        // Configuration snapping complète - TOUTES DIRECTIONS ACTIVES
        snapGap={true}
        snapDirections={{
          top: true,
          left: true,
        ...
        // DEBUG: Affichage des distances pour voir si ça fonctionne
        isDisplaySnapDigit={true}
        snapDigit={1}
        isDisplayInnerSnapDigit={false}
        maxSnapElementGuidelineDistance={1000}
        
        // Guidelines éléments vides pour éviter conflits
        elementGuidelines={[]}
        
        // Force les guidelines à être visibles
