...
import { ChevronDown, Download, MenuIcon, ShareIcon, RectangleHorizontal, RectangleVertical, Square } from "lucide-react";
...
const RESIZE_OPTIONS: ResizeOptionProps[] = [
  {
    ...
    description: "Youtube, Vimeo and most video platforms",
    value: {
      width: 1920,
      height: 1080,
      name: "16:9",
  ...
  },
  {
    ...
    description: "TikTok, Youtube shorts, Facebook",
    value: {
      width: 1080,
      height: 1920,
      name: "9:16",
